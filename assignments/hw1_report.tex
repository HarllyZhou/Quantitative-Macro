...
\begin{enumerate}[label=\alph*.]
    ...
    \item Code in ``hw1\_q3.R''. Results are shown in Table \ref{tab:q3c}.
    ...
    \begin{table}[htbp]
      ...
      There is no convergence to the true value as $N$ increases.
      
      
      \item Code in ``hw1\_q3.R''. Results are shown in Table \ref{tab:q3d}.
      ...
      Convergence is seen by increasing $T$. Therefore, for $AR(1)$ model, the Nickell bias is mainly caused by the serial correlation. With $T$ going to infinity, the bias is smaller.
\end{enumerate}
